...
(cDBG)~\cite{Marcus:2014xy,Baier_2015,Beller:2016ab,Chikhi:2015aa,Minkin_2016,Chikhi_2016}
...
input genome(s). This strategy, however, is not scalable to hundreds of
genomes.
...
information in memory with simple labeling. While GBWT~\cite{Sir_n_2019}
provides a practical solution to storage and indexing, no existing tools can
practically construct a cDBG for many human genomes in the GBWT representation.
