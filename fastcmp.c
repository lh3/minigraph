...
int32_t mg_nwcmp(void *km, int32_t l1, const char *s1, int32_t l2, const char *s2, int8_t mat[25], int8_t gapo, int8_t gape, int8_t gapo2, int8_t gape2, int32_t w, int32_t *mlen_, int32_t *blen_)
{
	...
	ksw_extd2_sse(km, l1, t1, l2, t2, 5, mat, gapo, gape, gapo2, gape2, w, 1000, 0, 0, &ez); // 1000 for zdrop
