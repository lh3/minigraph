...
OBJS=		kalloc.o kthread.o gfa-base.o gfa-io.o gfa-sub.o sketch.o misc.o options.o bseq.o index.o \
			lchain.o gchain1.o gcmisc.o map.o ggen.o ggsimple.o format.o
PROG=		minigraph
LIBS=		-lz -lm
...
gchain1.o: mgpriv.h kalloc.h minigraph.h gfa.h ksort.h khash.h
...
ggen.o: kthread.h kalloc.h mgpriv.h minigraph.h gfa.h bseq.h
ggsimple.o: mgpriv.h kalloc.h minigraph.h gfa.h
